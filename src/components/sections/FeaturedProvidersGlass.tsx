...
const PROVIDERS: ProviderEntry[] = [
  ...
  },
  {
    ...
    displayName: "London Medical Lab",
    tagline: "Innovating Diagnostic Healthcare",
    description:
      "Professional UKAS-accredited laboratory services with comprehensive testing capabilities and ISO 15189 standards.",
    tags: ["UKAS Accredited", "ISO 15189", "Professional Lab"],
