    ...
    <section className="w-full py-12 sm:py-16 md:py-20 bg-[#f0fafb]">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-7xl mx-auto">
          ...
          <div className="bg-[#081129] rounded-2xl shadow-md p-4 lg:p-5 flex flex-col items-center text-center max-w-[75%] mx-auto md:max-w-none">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mb-2 mt-1">
              <Link
                to="/compare"
