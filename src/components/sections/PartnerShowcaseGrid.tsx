    ...
    <section className="w-full py-12 sm:py-16 md:py-20 bg-[#f0fafb]">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 max-w-7xl mx-auto">
          ...
          <div className="bg-[#081129] rounded-2xl shadow-md p-4 lg:p-5 flex flex-col items-center text-center max-w-[75%] mx-auto">
            <span className="inline-block bg-[#22c0d4]/15 text-[#22c0d4] text-xs font-semibold uppercase tracking-wider px-3 py-1 rounded-full mb-1.5">
              Start Your Journey Today
            </span>
            <h3 className="font-heading text-lg lg:text-xl font-bold text-white mb-1">
              Take Control of Your Health Today
            </h3>
            <p className="text-sm text-white/70 leading-relaxed mb-16">
              Compare trusted, accredited health tests from leading UK providers. Find the right test for your needs in minutes.
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center mb-2 mt-8">
              <Link
                to="/compare"
