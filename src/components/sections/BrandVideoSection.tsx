      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex flex-col sm:flex-row gap-6 sm:gap-12 max-w-5xl mx-auto sm:items-start justify-center">
          <video
            ...
            playsInline
            preload="auto"
            className="w-full sm:w-[50%] sm:flex-shrink-0 h-auto rounded-lg sm:rounded-xl sm:scale-110 sm:origin-top-left sm:-translate-x-[1cm]"
          ...
          <video
            ...
            playsInline
            preload="auto"
            className="w-full sm:w-[45%] h-auto rounded-lg sm:rounded-xl sm:mt-[2.5cm]"
