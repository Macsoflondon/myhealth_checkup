            ...
            <div className="max-w-[1240px] mx-auto">
              ...
              <div className="max-w-[1140px] mx-auto">
                <div className="bg-white/10 backdrop-blur-md rounded-2xl sm:rounded-3xl p-3 sm:p-4 border border-[hsl(var(--navy))] shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),0_4px_16px_rgba(0,0,0,0.1)]">
                  ...
                  <div className="mt-3 sm:mt-4 bg-white/10 backdrop-blur-md rounded-xl p-2.5 sm:p-3 text-center border shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),0_4px_16px_rgba(0,0,0,0.1)] border-[hsl(var(--navy))] max-w-[900px] mx-auto">
