              ...
              <div className="max-w-[780px] mx-auto">
                <div className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-7 border-primary border-2 shadow-xl">
                  ...
                  <div className="mt-4 sm:mt-5 bg-gray-50 rounded-xl p-4 sm:p-5 text-center opacity-70">
                    ...
                    <div className="flex flex-wrap gap-2 sm:gap-3 justify-center opacity-80">
                      {popularSearches.map((search, index) => (
                        <button
                          key={index}
                          onClick={() => navigate(search.route)}
                          className="px-4 sm:px-5 py-2 text-[#081129] bg-[hsl(var(--primary))] hover:bg-[hsl(var(--secondary))] rounded-full transition-colors duration-300 font-medium"
                        >
                          {search.name}
                        </button>
                      ))}
