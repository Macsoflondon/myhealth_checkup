        ...
        <div className="relative z-10 container mx-auto px-3 sm:px-4 md:px-6 lg:px-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="max-w-3xl mx-auto text-left mb-4 sm:mb-6 md:mb-8">
              <div className="border-l-4 border-brand-turquoise pl-4 sm:pl-6 space-y-3 sm:space-y-4 text-gray-700 font-sans text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed">
