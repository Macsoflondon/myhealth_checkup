                ...
                <div className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-7 border-primary border-2 shadow-xl">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 sm:pl-14 pr-4 py-4 sm:py-5 text-base sm:text-lg rounded-xl sm:rounded-2xl focus:ring-2 focus:ring-[hsl(var(--primary))] focus:border-[hsl(var(--primary))] focus:outline-none text-[hsl(var(--navy))] bg-white placeholder:text-[hsl(var(--primary))]/50 border-2 border-primary"
                    />
                    {isAnalyzing && (
