...
const norm = (
  k: FeaturedKit,
): Required<Pick<FeaturedKit, "name">> & FeaturedKit => ({
            ...
            style={
              {
                ...
                paddingBottom: "3.3cqw",
              } as React.CSSProperties
            }
          >
            <svg
              viewBox="0 0 48 48"
              style={{ width: "36%", minWidth: 13, height: "auto" }}
              fill="none"
              stroke="#0e1b3d"
              strokeWidth={1.5}
              strokeLinecap="round"
        ...
        >
          ...
          >
            ...
            <div
              style={
                {
                  borderLeft: `0.9cqw solid ${accent}`,
                  paddingLeft: "3.5%",
                  fontFamily: BODY,
                  fontWeight: 900,
                  fontSize: "5.4cqw",
...
.gbp-side .gbp-cta{margin-top:0!important}
            ...
            {wheel.map((k, i) => {
              ...
              return (
                <div
                  ...
                  onMouseEnter={() => {
                    if (!selKit && canHover) setHovered(i);
                  }}
                  onMouseLeave={() => {
                    if (!selKit) setHovered(null);
                  }}
          ...
          {preview && (
            <div
              style={{
                ...
                zIndex: 20000,
                pointerEvents: "none",
                animation: "gbpop .26s cubic-bezier(.4,0,.2,1) both",
              }}
            >
              <div className="gbp-preview">
                ...
                <div className="gbp-side">
                  <div>
                    ...
                    <div
                      style={{ fontSize: 12, color: "#8a94a3", marginTop: 2 }}
                    >
                      {preview.biomarkers}
                    </div>
                  </div>
          ...
          >
            <Link
              ...
              style={{
                ...
                color: "#fff",
                cursor: "pointer",
                boxShadow: "0 10px 24px -10px rgba(8,17,41,.5)",
      ...
      {selKit &&
        ...
        createPortal(
          <div
            onClick={() => {
              if (performance.now() - a.current.openedAt < 600) return;
              setSelKit(null);
              setHovered(null);
            }}
            style={{
          ...
          >
            <div
              ...
              style={{
                ...
                background: "#fff",
                borderRadius: 26,
                boxShadow: "0 50px 120px -30px rgba(0,0,0,.7)",
                animation: "gbpopc .3s cubic-bezier(.4,0,.2,1) both",
              }}
            >
              <button
                onClick={() => {
              ...
              >
                <div
                  style={{
                    ...
                    overflow: "hidden",
                    boxShadow:
                      "0 16px 34px -16px rgba(8,17,41,.45),0 0 0 1px rgba(8,17,41,.05)",
                  }}
                >
                  <KitFace
                    name={selKit.name}
                    sample={selKit.sample!}
                    accent={selKit.accent}
                    texture={faceTexture}
                  />
                </div>
                <div style={{ flex: 1, minWidth: 0, textAlign: "left" }}>
                  ...
                  >
                    ...
                    <span style={{ fontSize: 13, color: "#8a94a3" }}>
                      incl. lab analysis
                    </span>
                  </div>
                </div>
              ...
              <div style={{ padding: "8px 36px 0" }}>
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                  {[
                    selKit.biomarkers,
                    selKit.turnaround ? `Results in ${selKit.turnaround}` : "",
                    selKit.collection,
                  ]
                    .filter(Boolean)
                    .map((c, i) => (
                ...
                >
                  ...
                  <div style={{ fontSize: 13, color: "#6b7585", marginTop: 4 }}>
                    Take your sample at home or in one of 200+ UK clinics,
                    return it in the pre-paid envelope, and receive a clear,
                    GP-reviewed report. All samples are processed in
              ...
              >
                <Link
                  ...
                  style={{
                    ...
                    color: "#fff",
                    cursor: "pointer",
                    boxShadow: "0 12px 26px -12px rgba(34,192,212,.8)",
                    whiteSpace: "nowrap",
                  }}
                >
                  Compare this test
      ...
      style={
        {
          ...
          height: 54,
          borderRadius: "50%",
          border: `1px solid ${h ? "#22c0d4" : "#e3e8ee"}`,
          background: h ? "#22c0d4" : "rgba(255,255,255,0.92)",
          boxShadow: "0 10px 24px -10px rgba(8,17,41,.35)",
          cursor: "pointer",
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
