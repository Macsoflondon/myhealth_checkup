        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10 sm:mb-12 px-2 animate-fade-in [animation-delay:300ms]">
            <Button 
              asChild 
              size="lg" 
              className="bg-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))]/90 text-white px-8 py-6 text-base sm:text-lg rounded-xl w-full sm:w-auto min-h-[52px] shadow-lg shadow-[hsl(var(--primary))]/30 hover:shadow-xl hover:shadow-[hsl(var(--primary))]/40 transition-all duration-300 hover:-translate-y-0.5"
            >
              <Link to="/compare">
                Find a test
            ...
            <Button 
              ...
              variant="outline" 
              size="lg" 
              className="border-2 border-white/50 bg-white/15 text-white hover:bg-white hover:text-[hsl(var(--navy))] px-8 py-6 text-base sm:text-lg rounded-xl backdrop-blur-md w-full sm:w-auto min-h-[52px] transition-all duration-300 hover:-translate-y-0.5 shadow-lg"
            >
