...
import { ArrowRight, TestTube2, Clock, Droplets } from "lucide-react";
            ...
            {popularTests?.slice(0, 12).map((test) => (
              ...
              >
                ...
                <div className="p-4 pt-0 flex-1 flex flex-col">
                  <h3 className="font-semibold text-foreground mb-3 line-clamp-2 group-hover:text-primary transition-colors min-h-[48px]">
