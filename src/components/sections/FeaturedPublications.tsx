                  ...
                  {group.map((publication) => (
                    ...
                    >
                      <a 
                        ...
                        className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-400 text-center transition-all duration-200 hover:scale-105 hover:text-[#e70d69] cursor-pointer block"
                      >
                        {publication.name}
                      </a>
                    </div>
