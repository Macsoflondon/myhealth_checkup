...
export default function StatsBand() {
  return (
    <section className="rounded-t-none rounded-b-[28px] overflow-hidden bg-[#F5F5F5] border border-t-0 border-[#081129]/[0.06] shadow-[0_30px_80px_rgba(8,17,41,0.10)] px-6 sm:px-[30px] pt-6 sm:pt-8 pb-[18px]">
      <div className="relative overflow-hidden rounded-[22px] bg-[#081129] px-6 sm:px-[34px] py-10 sm:py-[56px] flex flex-col sm:flex-row items-center sm:justify-center gap-6 flex-wrap min-h-[180px] sm:min-h-[220px] text-center">
        ...
        <div className="relative w-full sm:w-auto">
          <h2 className="font-extrabold text-[clamp(1.9rem,7.5vw,3rem)] tracking-[-0.02em] leading-[1.15] text-white m-0 font-[Montserrat] break-words">
