...
import letterboxVideo from "@/assets/letterbox-kit-v2.mp4.asset.json";
          ...
          <div className="p-6 sm:p-8 md:p-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 lg:gap-10">
            ...
            <div className="flex-1 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-3 mb-4">
                ...
                <span className="text-sm sm:text-base font-semibold uppercase tracking-[0.25em] text-brand-turquoise">
                  Start Your Journey
                </span>
