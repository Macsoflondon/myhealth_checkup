      ...
      <Card className="p-6">
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <p className="text-brand-navy">We only work with UKAS-accredited, CQC-regulated, and ISO 15189-certified providers.</p>
          </div>
          <div className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 text-green-600 mt-1" />
            <p className="text-brand-navy">Commission does not affect the price you pay or compromise the independence of our comparisons.</p>
          </div>
          <div className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 text-green-600 mt-1" />
            <p className="text-brand-navy">This arrangement helps support the operation of our platform at no additional cost to you.</p>
          </div>
          <div className="flex items-start gap-3">
            <CheckCircle className="h-5 w-5 text-green-600 mt-1" />
            <p className="text-brand-navy">For transparency, any affiliate links are clearly marked.</p>
          </div>
        </div>
      </Card>
