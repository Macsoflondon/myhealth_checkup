  ...
  return <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      <Card className="p-6">
        ...
        <div className="space-y-4">
          <p className="text-brand-navy mb-4">We may collect the following categories of data:</p>
          <div>
            <h3 className="font-medium mb-2">Personal identifiers:</h3>
            <p className="text-brand-navy text-sm">Name, email address, phone number.</p>
          </div>
          <div>
            <h3 className="font-medium mb-2">User preferences:</h3>
            <p className="text-brand-navy text-sm">Tests of interest, saved searches, selections.</p>
          </div>
          <div>
            <h3 className="font-medium mb-2">Technical data:</h3>
            <p className="text-brand-navy text-sm">IP address, browser type, device information, cookies.</p>
          </div>
          <div>
            <h3 className="font-medium mb-2">Special category data:</h3>
            <p className="text-brand-navy text-sm">Limited health-related preferences (e.g., interest in fertility or hormone tests).</p>
          </div>
          <div>
            <h3 className="font-medium mb-2">Marketing data:</h3>
            <p className="text-brand-navy text-sm">Your communication preferences and interactions with our emails or Website.</p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-6">
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            ...
            <p className="text-brand-navy">Directly from you when you create an account, sign up for emails, or interact with the Website.</p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-health-600 rounded-full mt-2"></div>
            <p className="text-brand-navy">Automatically via cookies and analytics tools.</p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-health-600 rounded-full mt-2"></div>
            <p className="text-brand-navy">From third parties where you interact with our referral partners (subject to their consent and agreements).</p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-6">
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-health-600 rounded-full mt-2"></div>
            <p className="text-brand-navy"><strong>Consent:</strong> For email marketing and processing any health-related preferences.</p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-health-600 rounded-full mt-2"></div>
            <p className="text-brand-navy"><strong>Legitimate interests:</strong> For Website functionality, service improvement, and fraud prevention.</p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-health-600 rounded-full mt-2"></div>
            <p className="text-brand-navy"><strong>Legal obligations:</strong> To comply with regulatory or legal requirements.</p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-6">
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-health-600 rounded-full mt-2"></div>
            <p className="text-brand-navy">To provide our comparison and referral services.</p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-health-600 rounded-full mt-2"></div>
            <p className="text-brand-navy">To personalise your experience.</p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-health-600 rounded-full mt-2"></div>
            <p className="text-brand-navy">To send you relevant communications (if you have consented).</p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-health-600 rounded-full mt-2"></div>
            <p className="text-brand-navy">To improve our Website and protect its security.</p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-6">
        ...
        <p className="text-brand-navy mb-4">We may share your data with:</p>
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-health-600 rounded-full mt-2"></div>
            <p className="text-brand-navy"><strong>Service providers:</strong> To provide Website functionality (e.g., hosting, analytics).</p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-health-600 rounded-full mt-2"></div>
            <p className="text-brand-navy"><strong>Referral partners:</strong> Where you select a third-party provider (subject to explicit consent).</p>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-2 h-2 bg-health-600 rounded-full mt-2"></div>
            <p className="text-brand-navy"><strong>Regulators or legal authorities:</strong> Where required by law.</p>
          </div>
        </div>
        <p className="text-brand-navy mt-4 font-medium">We do not sell your personal data.</p>
      </Card>

      <Card className="p-6">
        <h2 className="text-xl font-semibold mb-4">8. Your Rights</h2>
        <p className="text-brand-navy mb-4">You have the following rights under UK GDPR:</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <h3 className="font-medium">Access your data</h3>
            <p className="text-sm text-brand-navy">Request a copy of your personal data</p>
          </div>
          <div className="space-y-2">
            <h3 className="font-medium">Correct inaccurate data</h3>
            <p className="text-sm text-brand-navy">Update or fix incorrect information</p>
          </div>
          <div className="space-y-2">
            <h3 className="font-medium">Request deletion</h3>
            <p className="text-sm text-brand-navy">"Right to be forgotten"</p>
          </div>
          <div className="space-y-2">
            <h3 className="font-medium">Restrict or object</h3>
            <p className="text-sm text-brand-navy">Limit or stop processing</p>
          </div>
          <div className="space-y-2">
            <h3 className="font-medium">Withdraw consent</h3>
            <p className="text-sm text-brand-navy">Stop marketing communications</p>
          </div>
          <div className="space-y-2">
            <h3 className="font-medium">Data portability</h3>
            <p className="text-sm text-brand-navy">Transfer your data</p>
          </div>
        </div>
        <p className="text-brand-navy mt-4">Contact: support@myhealthcheckup.co.uk to exercise these rights.</p>
      </Card>
      ...
      <Card className="p-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-brand-navy">support@myhealthcheckup.co.uk</span>
        </div>
      </Card>
