  ...
  return (
    ...
    >
      <Link
        ...
        className={`group inline-flex max-w-[150px] items-center rounded-full no-underline bg-white border-[1.5px] hover:-translate-y-0.5 transition-all duration-200 shrink-0 md:max-w-[132px] lg:max-w-[150px] xl:max-w-none ${
          compact
      ...
      >
        ...
        >
          <Icon
            className={compact ? "w-[9px] h-[9px] sm:w-[10px] sm:h-[10px]" : "w-[11px] h-[11px] sm:w-[12px] sm:h-[12px]"}
            style={{ color }}
            strokeWidth={2}
          />
        </span>
        ...
        {hasDropdown && (
          <ChevronDown
            className={`text-[#081129]/60 transition-transform ${open ? "rotate-180" : ""} ${
              compact ? "w-2.5 h-2.5 shrink-0" : "w-2.5 h-2.5"
            }`}
          />
        )}
      </Link>
