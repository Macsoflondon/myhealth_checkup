  ...
  return (
    ...
    >
      <Link
        ...
        className={`group inline-flex items-center rounded-full no-underline bg-white border-[1.5px] hover:-translate-y-0.5 transition-all duration-200 shrink-0 ${dense ? "gap-1 pl-1.5 pr-1.5 py-2" : "gap-1 pl-1 pr-1.5 py-2 2xl:gap-2 2xl:pl-2.5 2xl:pr-3"} ${compact ? "sm:py-2.5" : "sm:py-2.5"}`}
        style={{
      ...
      >
        ...
        <span className={`font-semibold text-[#081129] font-[Montserrat] whitespace-nowrap ${dense ? "text-[13px] lg:text-[13.5px] tracking-[-0.015em]" : "text-[11.5px] lg:text-[12px] xl:text-[12.5px] 2xl:text-[15px] tracking-[-0.015em] 2xl:tracking-normal"}`}>
          {item.name}
        </span>
