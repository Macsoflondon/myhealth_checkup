          ...
          <div className="px-2 xs:px-3 py-2 flex items-center justify-between bg-[#22c0d4]">
            ...
            <div className="flex-1 flex justify-center px-1 xs:px-2">
              <img 
                ...
                className="h-8 xs:h-10 sm:h-12 w-auto object-contain animate-float drop-shadow-[0_0_12px_rgba(255,255,255,0.5)]" 
                src={taglineBanner} 
              />
            </div>
        ...
        <div className="bg-[#22c0d4] px-4 lg:px-8 xl:px-12">
          <div className="relative flex items-center justify-between py-3 lg:py-4">
            ...
            <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
              <img 
                alt="Your health. Your choice. One trusted platform!" 
                className="h-80 lg:h-96 xl:h-[28rem] w-auto object-contain animate-float hover:scale-105 drop-shadow-[0_0_20px_rgba(255,255,255,0.6)] hover:drop-shadow-[0_0_30px_rgba(255,255,255,0.8)] transition-all duration-300 cursor-default" 
                src={taglineBanner} 
              />
            </div>
