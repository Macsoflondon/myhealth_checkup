      ...
      <Card className="bg-card/50 backdrop-blur-sm border-border/50">
        <CardContent className="p-6">
          ...
          <div className="flex flex-wrap gap-2">
            <Button variant={selectedCategory === "all" ? "default" : "outline"} size="sm" onClick={() => onCategoryChange("all")} className={cn("rounded-full transition-all", selectedCategory === "all" && "bg-health-primary hover:bg-health-primary/90 text-white")}>
              All Tests
        ...
        <CardContent className="p-6 bg-white">
          <div className="grid gap-4 md:grid-cols-4">
            ...
            <div className="md:col-span-2 relative">
              ...
              <Input type="text" value={searchTerm} onChange={e => onSearchChange(e.target.value)} placeholder="Search for tests, conditions, or biomarkers..." className="pl-10 bg-background/50 border-border/50 focus:border-health-primary" />
            </div>
