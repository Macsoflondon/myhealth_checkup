      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-12">
            {partners.map((partner, index) => <Card key={index} className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6 flex items-center justify-center">
                  <img src={partner.logo} alt={`${partner.name} logo`} className="h-12 w-auto object-cover" />
                </CardContent>
              </Card>)}
          </div>
          ...
          <div className="text-center">
            <p className="mb-4 text-3xl font-medium text-[#8cf575] text-center">Our Partners have featured in:</p>
            <div className="flex flex-wrap justify-center gap-8 opacity-60">
              {mediaLogos.map((media, index) => <span key={index} className="text-lg font-semibold text-gray-400">
                  {media}
                </span>)}
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              <div className="h-48 bg-gradient-to-br from-pink-100 to-pink-200">
                <img src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=400" alt="Women's Health" className="w-full h-full object-cover" />
              </div>
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              <div className="h-48 bg-gradient-to-br from-blue-100 to-blue-200">
                <img src="https://images.unsplash.com/photo-1649972904349-6e44c42644a7?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=400" alt="Men's Health" className="w-full h-full object-cover" />
              </div>
              <CardContent className="p-6">
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              <div className="h-48 bg-gradient-to-br from-green-100 to-green-200">
                <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?ixlib=rb-4.0.3&q=85&fm=jpg&crop=entropy&cs=srgb&w=400" alt="Wellness" className="w-full h-full object-cover" />
              </div>
              <CardContent className="p-6">
