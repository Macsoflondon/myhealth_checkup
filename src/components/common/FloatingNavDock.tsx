...
const FloatingNavDock = () => {
  ...
  const btnBase =
    'group/btn relative flex items-center justify-center w-12 h-12 rounded-full text-white transition-all duration-300 hover:bg-[hsl(var(--brand-pink))] hover:text-white bg-primary';
