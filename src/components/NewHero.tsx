      ...
      <div className="container relative z-10 px-0 w-full py-0 mx-0 bg-[#081129]">
        <div className="max-w-6xl mx-auto text-center py-[20px] my-[20px]">
          ...
          <h1 className="text-4xl lg:text-6xl mb-6 leading-tight text-center font-semibold text-zinc-50 md:text-5xl my-[10px]">
            <span className="block py-[20px] font-semibold text-3xl my-[50px]">
              <span className="text-white text-left text-5xl">Compare the UK's leading private health test providers</span>
              <span className="text-[#22c0d4] text-5xl font-bold my-[20px]">All in one place!</span>
            </span>
          </h1>
