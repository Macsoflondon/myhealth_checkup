          ...
          <div className="w-full text-center px-4">
            ...
            <div className="mb-8 relative max-w-7xl mx-auto">
              ...
              aspectRatio: '16/9'
                ...
                {/* Hero images */}
                {heroImages.map((imageSrc, index) => <LazyImage key={imageSrc} src={imageSrc} alt="myhealth checkup - Your health is your greatest asset" className={`absolute inset-0 w-full h-full object-cover object-center transition-opacity duration-2000 ease-in-out ${index === currentImageIndex ? 'opacity-100' : 'opacity-0'}`} style={{transform: 'scaleY(1.15)', objectPosition: 'center center'}} width={1200} height={675} priority={index === 0} />)}
              </div>
            </div>
          </div>
        </div>
