      ...
      <div className="container relative z-10 px-0 w-full py-0 mx-0 bg-[#081129]">
        <div className="max-w-6xl mx-auto text-center py-[20px] my-[30px]">
          ...
          <h1 className="text-4xl lg:text-6xl mb-6 leading-tight text-center font-semibold text-zinc-50 md:text-5xl my-[10px]">
            <span className="block font-semibold text-3xl my-[70px] py-0 px-0">
              <span className="text-white text-center text-5xl my-0 font-medium">Compare the UK's leading private health test providers</span>
              <span className="text-[#22c0d4] text-5xl text-center font-semibold my-[20px]">All in one place!</span>
            </span>
          </h1>
