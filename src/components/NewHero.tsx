      ...
      <section className="w-full bg-[#081129] py-1.5 sm:py-2">
        <div className="w-full px-3 sm:px-4">
          <h1 className="text-[11px] sm:text-sm md:text-base lg:text-lg leading-tight font-normal text-center">
            <span className="text-white font-medium text-5xl px-[16px] py-[20px] my-[10px]">{t('hero.compareProviders')} </span>
            <span className="text-[#fc0173] font-medium text-left px-[206px] text-5xl py-[20px]">{t('hero.allInOnePlace')}</span>
          </h1>
        </div>
      </section>
