...
const NewHero = () => {
  ...
  const popularSearches = useMemo(() => [
    { name: "General Health Test", route: "/test/general-health" },
    { name: "Male Hormone Test", route: "/test/male-hormones" },
    { name: "Vitamin D Test", route: "/test/vitamin-d" },
    { name: "Iron Profile", route: "/test/iron-profile" },
    { name: "Well Woman Test", route: "/test/well-woman" }
  ], []);
    ...
    <>
      ...
      <section className="w-full py-8 bg-white">
        <div className="w-full px-4">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-[#22c0d4] text-center leading-tight">
              ...
              <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-2xl">
                <div className="flex flex-col sm:flex-row gap-4">
                  <div className="flex-1 relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-12 pr-4 py-3 sm:py-4 text-base sm:text-lg border-2 border-gray-200 rounded-xl focus:border-health-primary focus:outline-none text-gray-800 placeholder-gray-500" 
                    />
                  </div>
                  <Button 
                    ...
                    size="lg" 
                    className="px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg bg-[#22c0d4] hover:bg-[#22c0d4]/90 text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 disabled:opacity-50 min-h-[44px]" 
                ...
                {aiResults && (
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    {aiResults.alternativeProviders?.length > 0 && (
                      <div className="mb-4">
                        <h4 className="font-medium text-orange-800 mb-2">⚠️ Tests Not Available - Alternative Providers:</h4>
                        <div className="space-y-2">
                          {aiResults.alternativeProviders.map((alt: any, index: number) => (
                    ...
                    <Button 
                      ...
                      className="w-full mt-3 bg-health-primary hover:bg-health-primary/90"
                    >
                    ...
                    <div className="flex flex-wrap gap-2 justify-center">
                      {popularSearches.slice(0, 3).map((search, index) => (
                        <button 
                          ...
                          className="px-3 py-1 text-sm bg-gray-100 hover:bg-health-primary hover:text-white rounded-full transition-all duration-200 text-gray-700 font-sans"
                        >
                          {search.name}
                        </button>
                      ))}
