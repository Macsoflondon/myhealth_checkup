        ...
        <div className="max-w-6xl mx-auto text-center py-[20px] my-[30px]">
          ...
          <h1 className="text-4xl lg:text-6xl mb-6 leading-tight text-center font-semibold text-zinc-50 md:text-5xl my-[10px]">
            <span className="block font-semibold text-3xl my-[70px] py-0 px-0">
              <span className="text-white text-center my-0 font-medium text-5xl">Compare the UK's leading private health test providers</span>
              <span className="text-[#22c0d4] text-5xl text-center font-semibold my-[10px]">All in one place!</span>
            </span>
          </h1>
