...
const ExpertSupport = ({ className }: ExpertSupportProps) => {
  ...
  return <section className={cn("w-full bg-[#f9fafb] py-12 sm:py-16 md:py-20 relative", className)}>
      {/* Top fade from navy */}
      <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-[#081129] to-transparent pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-12">
          ...
          return <div key={index} className="bg-white rounded-2xl p-6 hover:shadow-xl transition-all duration-300 border border-gray-200 group hover:scale-105">
                ...
                <h3 className="text-xl font-bold text-[#081129] mb-3">
                  {feature.title}
                </h3>
