...
const getAccreditations = (providerId: string): string[] => {
  const map: Record<string, string[]> = {
    ...
    "randox-health": ["UKAS", "ISO 15189", "50+ Clinics UK & Ireland"],
    randox: ["UKAS", "ISO 15189", "50+ Clinics UK & Ireland"],
    thriva: ["ISO 13485", "CQC regulated labs", "CE-marked"],
    "lola-health": ["UKAS", "ISO 15189", "GMC-reviewed"],
    lola: ["CQC", "UKAS"],
    "london-medical-laboratory": ["UKAS", "ISO 15189"],
