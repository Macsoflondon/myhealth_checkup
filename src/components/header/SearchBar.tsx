  ...
  return <div className="relative w-full max-w-3xl">
      <form onSubmit={handleSearch} className="flex w-full">
        <div className="relative flex-1 flex justify-center items-center ">
          ...
          <Input type="text" placeholder="Search from over 300 tests" value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="pl-12 pr-4 w-full text-base ring-purple-100 focus:border-primary focus:ring-1 focus:ring-primary rounded-r-none rounded-sm py-[10px] px-[120px]" />
        </div>
