...
export const SearchBar = () => {
  ...
  return (
    <div className="relative w-full">
      <form onSubmit={handleSearch} className="flex w-full">
        <div className="relative flex-1">
          ...
          <Input 
            ...
            onFocus={handleFocus}
            onBlur={handleBlur}
            className="pl-10 pr-4 py-3 w-full border-gray-300 focus:border-primary focus:ring-1 focus:ring-primary rounded-r-none" 
          />
        </div>
      ...
      {showDropdown && (
        <div className="absolute top-full left-0 mt-1 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl z-50 w-full max-w-[600px]">
          <div className="p-6">
