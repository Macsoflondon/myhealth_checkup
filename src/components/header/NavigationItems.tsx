  ...
  return (
    <nav className={`relative ${className}`} aria-label="Main Navigation">
      ...
      >
        ...
        {activeDropdown === "MORE" && (
          <div className="absolute top-full right-0 mt-1 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl z-[100] min-w-[280px]">
            <div className="p-4">
