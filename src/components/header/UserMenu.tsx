        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              variant="ghost"
              size="sm"
              className="h-12 w-12 p-2 text-white hover:text-[#22c0d4] hover:bg-[#22c0d4]/20 border-2 border-white/40 hover:border-[#22c0d4] rounded-lg transition-colors flex-shrink-0 bg-[#081129]"
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            variant="ghost"
            size="sm"
            className="h-12 w-12 p-2 text-white hover:text-[#22c0d4] hover:bg-[#22c0d4]/20 border-2 border-white/40 hover:border-[#22c0d4] rounded-lg transition-colors bg-[#081129]"
            aria-label="User menu"
          >
            <User className="h-5 w-5" />
          </Button>
