  ...
  medichecks: {
    ...
    whyChoose: {
      ...
      items: [
        ...
        { bold: 'Track Your Health:', text: 'The Medichecks portal lets you view results, monitor changes, and store your medical history over time' },
    ...
    quickInfo: {
      ...
      resultsDelivery: 'Medichecks online dashboard with doctor\'s report',
