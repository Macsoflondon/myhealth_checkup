            ...
            <div className="space-y-8">
              {faqCategories.map((category, categoryIndex) => <Card key={categoryIndex}>
                  <CardHeader className="bg-[#081129]">
                    <CardTitle className="text-xl text-[#e70d69]">{category.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <Accordion type="single" collapsible className="w-full">
                      {category.faqs.map((faq, faqIndex) => <AccordionItem key={faqIndex} value={`${categoryIndex}-${faqIndex}`}>
