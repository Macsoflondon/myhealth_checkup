      ...
      <main className="flex-grow bg-muted/30">
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto">
              ...
              <CardContent className="space-y-4">
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                  ...
                  <p className="text-amber-700 text-sm">
                    Our service is for informational purposes only and does not constitute medical advice, 
            ...
            <Card className="mb-8">
              <CardHeader>
                <CardTitle>5. Booking and Payments</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold mb-2">Test Bookings</h4>
                    <p className="text-sm text-muted-foreground">
                      When you book a test through our platform, you enter into a direct contract with the test provider. 
                      We act as an intermediary to facilitate the booking process.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-2">Pricing</h4>
                    <p className="text-sm text-muted-foreground">
                      Prices displayed are provided by test providers and may change. Final pricing is confirmed 
                      during the booking process with the provider.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-2">Cancellations & Refunds</h4>
                    <p className="text-sm text-muted-foreground">
                      Cancellation and refund policies are determined by individual test providers. 
                      Please review their terms before booking.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="mb-8">
              ...
              <CardContent>
                <p className="mb-4">
                  ...
                  is governed by our Privacy Policy, which complies with UK GDPR requirements.
                </p>
                <p className="text-sm text-muted-foreground">
                  By using our service, you consent to our Privacy Policy and cookie usage as outlined 
            ...
            <Card className="mb-8">
              ...
              <CardContent>
                ...
                <p className="text-sm text-muted-foreground">
                  Our maximum liability for any claims shall not exceed the amount paid by you for our services 
