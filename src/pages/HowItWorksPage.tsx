          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="mb-8">
                  <h3 className="text-2xl font-bold text-health-500 mb-4">Step 1: Choosing Your Test</h3>
                ...
                <div className="mb-8">
                  <h3 className="text-2xl font-bold text-health-500 mb-4">Step 2: Booking Your Test</h3>
                ...
                <div>
                  <h3 className="text-2xl font-bold text-health-500 mb-4">Step 3: Getting Results & Aftercare</h3>
