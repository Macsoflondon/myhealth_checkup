              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-l-4 border-health-500 pl-6">
                    <h4 className="text-xl font-semibold mb-2 text-[#22c0d4]">How do I choose the right test for my needs?</h4>
                  ...
                  <div className="border-l-4 border-health-500 pl-6">
                    <h4 className="text-xl font-semibold mb-2 text-[#22c0d4]">What information is provided for each test?</h4>
                  ...
                  <div className="border-l-4 border-health-500 pl-6">
                    <h4 className="text-xl font-semibold mb-2 text-[#22c0d4]">Can I compare tests from different providers?</h4>
                  ...
                  <div className="border-l-4 border-health-500 pl-6">
                    <h4 className="text-xl font-semibold mb-2 text-[#22c0d4]">Do I need a doctor's referral to book a test?</h4>
                ...
                {/* Step 2: Booking Your Test */}
                <div className="space-y-6">
                  <h3 className="text-2xl font-bold text-[#FA6980] mb-4">Step 2: Booking Your Test</h3>
                  
                  <div className="border-l-4 border-health-500 pl-6">
                    <h4 className="text-xl font-semibold mb-2 text-[#22c0d4]">How do I book my test?</h4>
                  ...
                  <div className="border-l-4 border-health-500 pl-6">
                    <h4 className="text-xl font-semibold mb-2 text-[#22c0d4]">Can I get my test done at home?</h4>
                  ...
                  <div className="border-l-4 border-health-500 pl-6">
                    <h4 className="text-xl font-semibold mb-2 text-[#22c0d4]">What payment methods are accepted?</h4>
                  ...
                  <div className="border-l-4 border-health-500 pl-6">
                    <h4 className="text-xl font-semibold mb-2 text-[#22c0d4]">Can I cancel or reschedule my appointment?</h4>
                ...
                {/* Step 3: Getting Results & Aftercare */}
                <div className="space-y-6">
                  <h3 className="text-2xl font-bold text-[#FA6980] mb-4">Step 3: Getting Results & Aftercare</h3>
                  
                  <div className="border-l-4 border-health-500 pl-6">
                    <h4 className="text-xl font-semibold mb-2 text-[#22c0d4]">How long does it take to get my results?</h4>
                  ...
                  <div className="border-l-4 border-health-500 pl-6">
                    <h4 className="text-xl font-semibold mb-2 text-[#22c0d4]">How will I receive my results?</h4>
                  ...
                  <div className="border-l-4 border-health-500 pl-6">
                    <h4 className="text-xl font-semibold mb-2 text-[#22c0d4]">Are the test results accurate and reliable?</h4>
                  ...
                  <div className="border-l-4 border-health-500 pl-6">
                    <h4 className="text-xl font-semibold mb-2 text-[#22c0d4]">What should I do after receiving my results?</h4>
