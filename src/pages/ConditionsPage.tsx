  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Specialized health tests for specific medical conditions including diabetes, heart health, thyroid disorders, and more. Professional testing from trusted UK providers." />
        ...
        <meta property="og:description" content="Specialized health tests for specific medical conditions." />
                        ...
                        <CardHeader className="pb-4">
                          <div className="flex items-center gap-3 mb-2">
                            <div 
                              ...
                              style={{ backgroundColor: `${condition.colorHex}20` }}
                            >
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Use our guided questionnaire to find the perfect test for your symptoms
                </p>
                <Link to="/assisted-test-finder">
                  <Button size="lg" className="bg-[#e70d69] hover:bg-[#e70d69]/90 text-white">
