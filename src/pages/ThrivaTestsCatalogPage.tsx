  ...
  return (
    <MainLayout>
      <Helmet>
        ...
        <meta name="description" content="Browse all Thriva at-home blood tests. Subscription-based health monitoring with app tracking. Compare prices and order your test kit." />
      </Helmet>
      <div className="min-h-screen bg-gray-50">
        <ProviderCatalogHeader providerId={PROVIDER_ID} providerName={PROVIDER_NAME} tagline="At-home blood testing with smart health tracking" testCount={tests?.length || 0} isLoading={isLoading} categories={categories} selectedCategory={selectedCategory} onCategoryChange={setSelectedCategory} features={PROVIDER_FEATURES[PROVIDER_ID]} />
