...
const CompareTests = () => {
  ...
  return <ErrorBoundary>
      ...
      <main className="flex-grow">
        {/* Hero Section - Brand headline */}
        <section className="py-6 sm:py-10 md:py-14 bg-[#081129]">
          <div className="container mx-auto max-w-7xl px-4 text-center">
            {/* Brand Tagline */}
            <p className="text-[#22c0d4] font-medium text-sm sm:text-base mb-2 sm:mb-3 tracking-wide">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 text-white leading-tight">
              Compare Health Tests from Trusted UK Providers
            </h1>
            
            <p className="text-sm sm:text-base md:text-lg max-w-2xl mx-auto mb-4 sm:mb-6 text-white/80">
              Side-by-side comparison of prices, turnaround times, and biomarkers from {memoizedStats.providerCount} accredited providers.
            </p>
            
            {/* Quick Stats */}
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
              <div className="flex items-center gap-1.5 bg-primary/15 backdrop-blur-sm rounded-full px-4 py-2">
                <TrendingUp className="h-4 w-4 text-primary" />
                <span className="text-xs sm:text-sm font-medium text-white">{memoizedStats.testCount}+ Tests</span>
              </div>
              <div className="flex items-center gap-1.5 bg-[#22c0d4]/15 backdrop-blur-sm rounded-full px-4 py-2">
                <Clock className="h-4 w-4 text-[#22c0d4]" />
                <span className="text-xs sm:text-sm font-medium text-white">Live Prices</span>
              </div>
              <div className="flex items-center gap-1.5 bg-green-500/15 backdrop-blur-sm rounded-full px-4 py-2">
                <Sparkles className="h-4 w-4 text-green-400" />
                <span className="text-xs sm:text-sm font-medium text-white">UKAS Accredited</span>
              </div>
            </div>
          </div>
        </section>
