  ...
  return (
    <MainLayout>
      <Helmet>
        ...
        <meta name="description" content="Browse all Lola Health blood tests. Women-focused health testing with home kits and expert support. Compare prices and order your test." />
      </Helmet>
      <div className="min-h-screen bg-gray-50">
        <ProviderCatalogHeader providerId={PROVIDER_ID} providerName={PROVIDER_NAME} tagline="Personalised health testing designed for women" testCount={tests?.length || 0} isLoading={isLoading} categories={categories} selectedCategory={selectedCategory} onCategoryChange={setSelectedCategory} features={PROVIDER_FEATURES[PROVIDER_ID]} />
