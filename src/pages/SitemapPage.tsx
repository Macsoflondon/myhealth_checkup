      ...
      <main className="flex-grow bg-[#081129]">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto">
                  ...
                  <CardContent>
                    <ul className="space-y-2">
                      {section.links.map((link, linkIndex) => <li key={linkIndex}>
                          <Link to={link.path} className="text-primary hover:text-primary/80 transition-colors text-sm">{link.name}</Link>
                        </li>)}
                    </ul>
                  </CardContent>
                </Card>)}
            ...
            <Card className="mt-8">
              <CardHeader><CardTitle>Need Help Finding Something?</CardTitle></CardHeader>
              <CardContent>
                <p className="mb-4">Can't find what you're looking for? Our search function and customer support team are here to help.</p>
                <div className="flex flex-wrap gap-4">
                  <Link to="/search" className="text-primary hover:text-primary/80">Try our intelligent search →</Link>
