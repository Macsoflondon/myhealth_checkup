...
const PROVIDER_NAME = "Goodbody Clinic";
...
const GoodbodyTestsCatalogPage = () => {
  ...
  return (
    <MainLayout>
      <Helmet>
        <title>Goodbody Clinic Blood Tests | Compare Health Tests UK</title>
        <meta name="description" content="Browse all Goodbody Clinic blood tests. Compare prices, biomarkers, and book your private health screening at clinic locations across the UK." />
      </Helmet>
      <div className="min-h-screen bg-gray-50">
        <ProviderCatalogHeader providerId={PROVIDER_ID} providerName={PROVIDER_NAME} tagline="Premium private blood testing with in-clinic phlebotomy" testCount={tests?.length || 0} isLoading={isLoading} categories={categories} selectedCategory={selectedCategory} onCategoryChange={setSelectedCategory} features={PROVIDER_FEATURES[PROVIDER_ID]} />
...
export default GoodbodyTestsCatalogPage;
