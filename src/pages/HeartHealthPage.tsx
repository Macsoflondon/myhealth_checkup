...
const HeartHealthPage = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>Heart Health Blood Tests | Cholesterol & Cardiac Risk Testing | My Health Checkup</title>
        ...
        {/* Open Graph Tags */}
        <meta property="og:title" content="Heart Health Blood Tests | My Health Checkup" />
        ...
        <meta name="twitter:title" content="Heart Health Blood Tests | My Health Checkup" />
        ...
        <section className="bg-gradient-to-br from-primary/5 to-secondary/5 py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <Badge className="mb-4">Heart Health</Badge>
