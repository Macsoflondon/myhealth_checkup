...
const VideoUpload = lazy(() =>
  import("@/components/VideoUpload").then((module) => ({ default: module.VideoUpload }))
);
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        ...
        <meta
          name="description"
          content="UK's leading health test comparison platform. Compare private blood tests, hormone checks, and health screenings from 10+ providers. Hospital-grade testing, real-time prices, expert reviews. Find your perfect health test today."
        />
        <meta
          name="keywords"
        ...
        <meta
          ...
          content="Compare private health tests from 10+ UK providers. Real-time prices, expert reviews, and AI recommendations. Hospital-grade testing made simple."
        />
        ...
        <meta
          ...
          content="Compare private blood tests, health screenings & wellness services. Real-time prices from 10+ providers. AI-powered recommendations."
        />
      ...
      <main id="main-content" className="flex-1">
        ...
        <section className="py-16 bg-muted/40">
          <div className="container mx-auto px-4 grid gap-8 md:grid-cols-2 items-start">
            <Suspense fallback={<div className="h-48 rounded-lg bg-muted animate-pulse" aria-hidden="true" />}>
